...
import io.github.grabdoc.evals4j.junit5.EvalAssert;
import io.github.grabdoc.evals4j.junit5.EvalReport;
...
import io.github.grabdoc.evals4j.trajectory.ToolArgsMatchMode;
import io.github.grabdoc.evals4j.trajectory.TrajectoryMatchEvaluator;
import io.github.grabdoc.evals4j.trajectory.TrajectoryMatchMode;
 ...
 * expensive part is opt-in. Second, an {@link EvalReport} is attached to every judge and written at
 * the end: for LLM scores the trend across runs is the signal, and a green tick alone cannot show
 * you that last week's 0.9 is now a 0.7.
 */
class EvalSuiteExampleTest {
    ...
    class ModelBacked {
        ...
        static void setUp() {
            ...
            // Attaching the report to each judge is what makes the summary possible.
