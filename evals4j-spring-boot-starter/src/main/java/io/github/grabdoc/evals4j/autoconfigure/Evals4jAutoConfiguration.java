...
public class Evals4jAutoConfiguration {
    ...
    @ConditionalOnClass({
        ...
        io.github.grabdoc.evals4j.springai.SpringAiJudgeModel.class
    })
    ...
    static class SpringAiConfiguration {
        ...
        JudgeModel evals4jJudgeModel(
            ...
            return io.github.grabdoc.evals4j.springai.SpringAiJudgeModel.of(
        ...
        EmbeddingProvider evals4jEmbeddingProvider(
            ...
            return io.github.grabdoc.evals4j.springai.SpringAiEmbeddingProvider.of(embeddingModel);
        }
    }
    ...
    @ConditionalOnClass({
        ...
        io.github.grabdoc.evals4j.langchain4j.LangChain4jJudgeModel.class
    })
    ...
    static class LangChain4jConfiguration {
        ...
        JudgeModel evals4jJudgeModel(
            ...
            return io.github.grabdoc.evals4j.langchain4j.LangChain4jJudgeModel.of(
                    chatModel, properties.getStructuredOutputMode());
        }
        ...
        EmbeddingProvider evals4jEmbeddingProvider(
            ...
            return io.github.grabdoc.evals4j.langchain4j.LangChain4jEmbeddingProvider.of(embeddingModel);
        }
    }
}
